...
var session_route_exports = {};
__export(session_route_exports, {
  default: () => session_route_default
});
module.exports = __toCommonJS(session_route_exports);
...
var SessionService = {
  async getUserSessions(userId, res) {
    try {
      if (!import_mongoose3.Types.ObjectId.isValid(userId)) {
  ...
  async deleteSession(sessionID, userID, req, res) {
    try {
      if (!import_mongoose3.Types.ObjectId.isValid(sessionID)) {
...
var session_route_default = router;
