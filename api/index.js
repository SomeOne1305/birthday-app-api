...
// node_modules/body-parser/node_modules/debug/src/common.js
var require_common = __commonJS({
  "node_modules/body-parser/node_modules/debug/src/common.js"(exports2, module2) {
    "use strict";
    function setup(env) {
...
var require_utils = __commonJS({
  "node_modules/body-parser/lib/utils.js"(exports2, module2) {
    ...
    function normalizeOptions(options2, defaultType) {
      if (!defaultType) {
...
var require_json = __commonJS({
  "node_modules/body-parser/lib/types/json.js"(exports2, module2) {
    ...
    function json(options2) {
      var { inflate, limit, verify, shouldParse } = normalizeOptions(options2, "application/json");
...
var require_raw = __commonJS({
  "node_modules/body-parser/lib/types/raw.js"(exports2, module2) {
    ...
    function raw(options2) {
      var { inflate, limit, verify, shouldParse } = normalizeOptions(options2, "application/octet-stream");
      function parse(buf) {
        return buf;
      }
...
var require_text = __commonJS({
  "node_modules/body-parser/lib/types/text.js"(exports2, module2) {
    ...
    function text(options2) {
      var { inflate, limit, verify, shouldParse } = normalizeOptions(options2, "text/plain");
...
var require_urlencoded = __commonJS({
  "node_modules/body-parser/lib/types/urlencoded.js"(exports2, module2) {
    ...
    function urlencoded(options2) {
      var { inflate, limit, verify, shouldParse } = normalizeOptions(options2, "application/x-www-form-urlencoded");
      var defaultCharset = options2?.defaultCharset || "utf-8";
...
var connectToDB = async () => {
  try {
    const conn = await import_mongoose.default.connect(
    ...
    logger_default.info(`MongoDB connected: ${conn.connection.host}`);
  } catch (error) {
    logger_default.warn(`Error occured while establishing connection to DB: ${error}`);
    process.exit(1);
  }
};
...
var verifyUserSchema = import_zod2.z.object({
  token: import_zod2.z.string().min(10)
});
var fillUserSchema = import_zod2.z.object({
  first_name: import_zod2.z.string().min(3),
  last_name: import_zod2.z.string().min(3),
  password: import_zod2.z.string().min(8),
  token: import_zod2.z.string().min(3)
});
var loginSchema = import_zod2.z.object({
  email: import_zod2.z.email(),
  password: import_zod2.z.string().min(3, { error: "Password must not be empty " })
});
var changePassSchema = import_zod2.z.object({
  token: import_zod2.z.string().min(4),
  password: import_zod2.z.string().min(8)
});
...
function checkNewPassword(password, old_hash, old_salt) {
  const hash = import_crypto2.default.pbkdf2Sync(password, old_salt, ITERATIONS, KEY_LENGTH, HASH_ALGO).toString("hex");
...
var birthdaySchema = new import_mongoose4.Schema(
  {
...
var Birthday = (0, import_mongoose4.model)("Birthday", birthdaySchema);
...
var BirthdayService = {
  ...
  async delete_date(user_id, date_id, res) {
    try {
      if (!import_mongoose5.default.Types.ObjectId.isValid(date_id)) {
...
app.use("/static", import_express5.default.static((0, import_node_path.join)(__dirname, "../public"), options));
setupSwagger(app);
app.get("/", home);
...
if (false) {
  app.listen(PORT).on("listening", async () => {
    await connectToDB();
    logger_default.info(`Server is listening on port http://localhost:${PORT}`);
  });
}
...
if (!isConnected) {
  connectToDB().then(() => {
    ...
    logger_default.error("MongoDB connection failed:", err);
  });
}
module.exports = app;
